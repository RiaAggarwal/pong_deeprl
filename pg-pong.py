...
if resume:
  ...
  running_reward = running_reward_history[-1]
  #print(running_reward_history)
else:
  model = {}
...
#env = wrappers.Monitor(env, 'videos/', force = True) #uncomment only if you want to save the videos in the video directory
